...
public class Game 
{
    ...
    private PointLight pLight1 = new PointLight(new BaseLight(
                                                new Vector3f(1, 0.5f, 0), 0.8f),
                                                new Attenuation(0, 0, 1),
                                                new Vector3f(-2, 0, 5f), 10);
    private PointLight pLight2 = new PointLight(new BaseLight(
                                                new Vector3f(0, 0.5f, 1), 0.8f),
                                                new Attenuation(0, 0, 1),
                                                new Vector3f(2, 0, 7f), 10);

    private SpotLight sLight1 = new SpotLight(new PointLight(new BaseLight(
	...
	public Game()
	{
		material = new Material(new Texture("test.png"), Shader.COLOR_WHITE, 1, 8);
        ...
        PhongShader.setDirectionalLight(new DirectionalLight(new BaseLight(Shader.COLOR_WHITE, 0.1f), new Vector3f(1, 1, 1)));
